            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              {[1, 2, 3].map((i) => (
                ...
                >
                  <div
                    className="skeleton"
                    style={{ height: 16, width: "40%", marginBottom: 8 }}
                  />
                  <div
                    className="skeleton"
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              {courses.map((course) => (
                ...
                >
                  ...
                  >
                    <i
                      className={`fa-solid ${course.isPublished ? "fa-circle-check" : "fa-circle"}`}
                      style={{ marginRight: 4 }}
                    />
                  ...
                  <div style={{ display: "flex", gap: 8, flexShrink: 0 }}>
                    ...
                    <Link
                      to={`/instructor/courses/${course._id}/quiz`}
                      className="btn-outline"
                      style={{ padding: "7px 12px", fontSize: 12 }}
                    >
                      <i className="fa-solid fa-wand-magic-sparkles" /> Quiz
                    </Link>
                    <button
                    ...
                    >
                      <i
                        className={`fa-solid ${course.isPublished ? "fa-eye-slash" : "fa-eye"}`}
                      />
