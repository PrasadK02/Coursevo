...
export const getCourses = createAsyncThunk(
  ...
  async (params, { rejectWithValue }) => {
    try {
      return (await fetchAllCourses(params)).data.data;
    } catch (e) {
...
export const getCourseById = createAsyncThunk(
  ...
  async (id, { rejectWithValue }) => {
    try {
      return (await fetchCourseById(id)).data.data.course;
    } catch (e) {
      return rejectWithValue(e.response?.data?.message || "Failed");
    }
  },
...
export const getMyCourses = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      return (await fetchMyCourses()).data.data.courses;
    } catch (e) {
      return rejectWithValue(e.response?.data?.message || "Failed");
    }
  },
...
export const createNewCourse = createAsyncThunk(
  ...
  async (data, { rejectWithValue }) => {
    try {
      return (await createCourse(data)).data.data.course;
    } catch (e) {
      return rejectWithValue(e.response?.data?.message || "Failed");
    }
  },
...
export const updateExistingCourse = createAsyncThunk(
  ...
  async ({ id, data }, { rejectWithValue }) => {
    try {
      return (await updateCourse(id, data)).data.data.course;
    } catch (e) {
      return rejectWithValue(e.response?.data?.message || "Failed");
    }
  },
...
export const addNewLesson = createAsyncThunk(
  "courses/addLesson",
  async ({ courseId, data }, { rejectWithValue }) => {
    try {
      return {
        courseId,
        lesson: (await addLesson(courseId, data)).data.data.lesson,
      };
    } catch (e) {
      return rejectWithValue(e.response?.data?.message || "Failed");
    }
...
export const deleteLessonFromCourse = createAsyncThunk(
  ...
  async ({ courseId, lessonId }, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        e.response?.data?.message || "Failed to delete lesson",
      );
    }
  },
);
...
export const enroll = createAsyncThunk(
  ...
  async (courseId, { rejectWithValue }) => {
    try {
      return (await enrollInCourse(courseId)).data.data.enrollment;
    } catch (e) {
      return rejectWithValue(
        e.response?.data?.message || "Already enrolled or error",
      );
    }
  },
);
...
export const markLessonComplete = createAsyncThunk(
  ...
  async ({ courseId, lessonId }, { rejectWithValue }) => {
    try {
      return (await updateProgress(courseId, { lessonId })).data.data
        .enrollment;
    } catch (e) {
      return rejectWithValue(e.response?.data?.message || "Failed");
    }
...
const courseSlice = createSlice({
  ...
  extraReducers: (b) => {
    ...
    b
      ...
      .addCase(getCourseById.fulfilled, (s, { payload }) => {
        s.loading = false;
        s.current = payload;
      })
      ...
      .addCase(getMyCourses.fulfilled, (s, { payload }) => {
        s.loading = false;
        s.myCourses = payload;
      })
      ...
      // createNewCourse
      .addCase(createNewCourse.pending, (s) => {
      ...
      .addCase(createNewCourse.rejected, (s, { payload }) => {
        s.actionLoading = false;
        s.error = payload;
      })
      ...
      // addNewLesson
      .addCase(addNewLesson.pending, (s) => {
        s.actionLoading = true;
        s.error = null;
      })
      ...
      .addCase(addNewLesson.rejected, (s, { payload }) => {
        s.actionLoading = false;
        s.error = payload;
      })

      //deleteLesson
      .addCase(deleteLessonFromCourse.fulfilled, (s, { payload }) => {
        if (s.current?._id === payload.courseId) {
          s.current.lessons = s.current.lessons.filter(
            (l) => l._id !== payload.lessonId,
          );
        }
        s.success = "Lesson deleted";
      })

      // enroll
      .addCase(enroll.pending, (s) => {
        s.actionLoading = true;
        s.error = null;
      })
      ...
      .addCase(enroll.rejected, (s, { payload }) => {
        s.actionLoading = false;
        s.error = payload;
      })
      ...
      .addCase(getMyEnrollments.fulfilled, (s, { payload }) => {
        s.loading = false;
      ...
      .addCase(markLessonComplete.fulfilled, (s, { payload }) => {
        const idx = s.enrollments.findIndex(
          (e) => e.course?._id === payload.course,
        );
        if (idx >= 0)
          s.enrollments[idx] = { ...s.enrollments[idx], ...payload };
      });
  },
});
